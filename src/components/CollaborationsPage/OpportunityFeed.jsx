...
export function OpportunityFeed({ collaborations, loading, onSave }) {
  if (loading) {
    return (
          ...
          >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-100">
              <div className="flex items-center gap-4 text-sm text-[#667085]">
                <span>{collab.view_count} views</span>
                <span>{collab.application_count} interested</span>
              </div>

              <a
                href={`/collaborations/${collab.id}`}
                className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-2.5 rounded-xl font-semibold hover:from-purple-700 hover:to-blue-700 transition-all flex items-center gap-2"
              >
                View Details
                <ArrowRight size={18} />
              </a>
